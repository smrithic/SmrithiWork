...
public class Magpie4 {
	...
	public String getResponse(String statement) {
		...
		} else if (findKeyword(statement, "find", 0) >= 0 && findKeyword(statement, "anywhere", 0) >= 0) {
	...
	private String transformSmellsBadStatement(String statement) {
		...
		return "I agree. " + restOfStatement + " does smells bad.";
	}
	...
	private String transformCantFind(String statement) {
		...
		int psnOfFind = findKeyword(statement, "find", 0);
		int psnOfAnywhere = findKeyword(statement, "anywhere", psnOfFind + 4);
